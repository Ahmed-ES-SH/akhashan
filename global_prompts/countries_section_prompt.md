Analyze the integration plan in plans/COUNTRIES_INTEGRATION_PLAN.md and the current implementation of the Countries section components, then build a structured, phased implementation plan and save it as a .md file in the workPlans/ folder.
The plan must:
...
7. Include a risks/blockers section
   Focus specifically on Countries section admin control and public display only — do not scope-creep into other sections.
The output MUST be a work plan saved as a .md file in workPlans/ named after the integration plan (e.g., workPlans/COUNTRIES_SECTION_PLAN.md).
Files for reference:

- Integration plan: plans/COUNTRIES_INTEGRATION_PLAN.md
- Current public component: app/_components/website/_home/CountriesSection.tsx
